...
def get_dt_targets(mes, area, category):
    ...
    targets = {
        9: {
            'ESTAMPADO': {'Mantenimiento': (3.0, 2.5), 'Matriceria': (7.0, 5.0), 'Tecnologia': (2.0, 1.0), 'Logistica': (2.0, 1.5), 'Gestion': (2.0, 1.5), 'Calidad': (0.0, 0.0)},
            'SOLDADURA': {'Mantenimiento': (2.0, 1.0), 'Dispositivo': (4.5, 3.0), 'Tecnologia': (4.5, 3.0), 'Logistica': (2.5, 1.5), 'Gestion': (2.0, 1.5), 'Calidad': (0.0, 0.0)}
        },
        10: {
            'ESTAMPADO': {'Mantenimiento': (3.0, 2.5), 'Matriceria': (5.0, 4.0), 'Tecnologia': (2.0, 1.0), 'Logistica': (2.0, 1.5), 'Gestion': (2.0, 1.5), 'Calidad': (0.0, 0.0)},
            'SOLDADURA': {'Mantenimiento': (2.0, 1.0), 'Dispositivo': (3.5, 2.0), 'Tecnologia': (3.5, 2.0), 'Logistica': (2.5, 1.5), 'Gestion': (2.0, 1.5), 'Calidad': (0.0, 0.0)}
        },
        11: {
            'ESTAMPADO': {'Mantenimiento': (3.0, 2.5), 'Matriceria': (2.5, 2.0), 'Tecnologia': (0.5, 0.25), 'Logistica': (2.0, 1.5), 'Gestion': (2.0, 1.5), 'Calidad': (0.0, 0.0)},
            'SOLDADURA': {'Mantenimiento': (1.5, 1.0), 'Dispositivo': (2.25, 1.75), 'Tecnologia': (2.25, 1.75), 'Logistica': (2.0, 1.5), 'Gestion': (2.0, 1.5), 'Calidad': (0.0, 0.0)}
        }
    }
...
def crear_pdf(area_req, label_reporte, op_target_df, prod_target_df, df_pdf_raw, p_tipo, df_trend, df_metrics_pdf, df_horarios, df_metrics_std_pdf, df_piezas_excluidas, mes=None):
    ...
    for g in grupos_area:
        ...
        if not df_fallas_area.empty:
            ...
            columnas_esperadas = ['Mantenimiento', col_disp_mat, 'Tecnologia', 'Logistica', 'Gestion', 'Calidad']
            ...
            def draw_head_dt():
                ...
                min_m_cal = round(min_p_cal * 4.5, 1)
                pdf.cell(30, 4, f"MIN: {min_p_cal}% ({min_m_cal:g}m)", 'LBR', 1, 'C', True)
